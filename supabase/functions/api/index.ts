...
import { patchMove, postApprove, postReject, postSchedule, postSlaRecalc, postSaveTokens, getSavedTokens, postSaveTokensBulk, getSavedTokensBulk } from './ordensHandlers.ts';
  ...
  try {
    ...
    if (effectivePath.startsWith('/ideias/') && effectivePath.includes('/approve') && req.method === 'POST') {
      ...
      const osData = {
        ...
        cta: ideia.cta || null,
        informacoes_adicionais: ideia.informacoes_adicionais,
