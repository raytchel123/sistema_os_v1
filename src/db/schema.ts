...
export const statusEnum = pgEnum('status_enum', ['ROTEIRO', 'AUDIO', 'CAPTACAO', 'EDICAO', 'REVISAO', 'APROVACAO', 'AGENDAMENTO', 'POSTADO', 'PUBLICADO', 'RASCUNHO']);
...
export const STATUS_OPTIONS = ['ROTEIRO', 'AUDIO', 'CAPTACAO', 'EDICAO', 'REVISAO', 'APROVACAO', 'AGENDAMENTO', 'PUBLICADO'] as const;
